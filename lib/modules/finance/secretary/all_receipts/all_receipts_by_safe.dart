...
import 'all_receipts_by_safe_controller.dart';



class AllReceipts extends StatelessWidget {
  AllReceiptsBySafeController _controller=Get.put(AllReceiptsBySafeController());
  AllReceipts({Key? key}) : super(key: key);
                                              ...
                                              child: SizedBox(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      "${_controller.receipts[index].patientName}",
                                                      style: TextStyle(
                                                        fontSize: getProportionateScreenWidth(18),
                                                        color:buttonColor,
                                                        fontFamily: "OpenSansBold",
                                              ...
                                              child: SizedBox(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      "${_controller.receipts[index].date!.substring(0,10)}",
                                                      style: TextStyle(
                                                        fontSize: getProportionateScreenWidth(18),
                                                        color:buttonColor,
                                                        fontFamily: "OpenSansBold",
                                              ...
                                              child: SizedBox(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      "${_controller.receipts[index].total}",
                                                      style: TextStyle(
                                                        fontSize: getProportionateScreenWidth(18),
                                                        color:buttonColor,
                                                        fontFamily: "OpenSansBold",
                                              ...
                                              child: SizedBox(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      "${_controller.receipts[index].discount}",
                                                      style: TextStyle(
                                                        fontSize: getProportionateScreenWidth(18),
                                                        color:buttonColor,
                                                        fontFamily: "OpenSansBold",
